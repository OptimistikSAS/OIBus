...
const ScanModes = ({ scanModes }) => scanModes && (
  <>
    <OIbTitle title="Scan Modes">
      <>
        <p>
          South protocols can scan the dataSources on a regular basis (every minute, every hour, ...). These scan
          modes needs to be defined in this section before they can be used on the various protocols. The syntax is
          derived from the unix cron syntax with a precision to the millisecond. The table below gives several examples.
        </p>
        <p>
          A special scanMode - listen - needs to be defined for protocols if you have protocols reacting to events mode such as MQTT
        </p>
        <table>
          <thead>
            <tr>
