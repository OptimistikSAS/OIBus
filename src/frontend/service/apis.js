...
const getLogs = (fromDate, toDate, pageNumber, pageSize, verbosity) => getRequest(
  `/logs?fromDate=${fromDate || ''}&toDate=${toDate || ''}&pageNumber=${pageNumber}&pageSize=${pageSize}&verbosity=[${verbosity}]`,
)
