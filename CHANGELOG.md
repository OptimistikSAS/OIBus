...
## [3.9.1](https://github.com/OptimistikSAS/OIBus/compare/v3.9.0...v3.9.1) (2026-09-04)
...
* **engine:** add engine name to init config and drop credential fields from user repository ([6780233](https://github.com/OptimistikSAS/OIBus/commit/67802336333b801f57b3e3d0156d7fe63a98c895))
* **engine:** configure default admin credentials and port at first run ([31c090b](https://github.com/OptimistikSAS/OIBus/commit/31c090bc2b3826a32e000a20ef56a78a8da0d688))
* **engine:** expose ignoreIpFilters and ignoreRemoteUpdate in OIBusInfo ([4b85c6b](https://github.com/OptimistikSAS/OIBus/commit/4b85c6b5d21804bd8ab02b1f9e3d41719c76f5fe))
* **engine:** split engine settings into dedicated endpoints ([971f93a](https://github.com/OptimistikSAS/OIBus/commit/971f93a177dd42e315e133bfff0f527684bfa5ef))
* **influxdb:** add InfluxDB south connector supporting v1, v2 and v3 ([0c08df7](https://github.com/OptimistikSAS/OIBus/commit/0c08df7d024bc5311670a85cfde289429f330693))
* **logger:** add group context to logs and translate internal scope ids ([e72e406](https://github.com/OptimistikSAS/OIBus/commit/e72e406aad7330999abf9b4af8409473e6140b12))
* **logger:** add item_id/item_name to log model and db migration ([c664a0f](https://github.com/OptimistikSAS/OIBus/commit/c664a0f82076850824d808621fb142d3701f9461))
* **logger:** add syslog transport ([4589c26](https://github.com/OptimistikSAS/OIBus/commit/4589c2675adbc5754acb437b4da012e2390ae1c5))
* **logger:** make LoggerService a singleton with self-healing proxy loggers ([76727bf](https://github.com/OptimistikSAS/OIBus/commit/76727bfd0de07e02a2405a5593ab922d4fe757e1))
* **logs:** improve logs page and search form ([96bc7ed](https://github.com/OptimistikSAS/OIBus/commit/96bc7edd89168fc44d41e0e00a34a37afd838adf))
* **logs:** send logs with item and groups to OIAnalytics ([0c101e5](https://github.com/OptimistikSAS/OIBus/commit/0c101e5325e52b15a098ea90b9ae6ba53ac8c8af))
* **manifest:** add os-specific field support ([da3996d](https://github.com/OptimistikSAS/OIBus/commit/da3996d126c5a3fa3cc8d5be778affb72ac87ff2))
* **north,south:** re-authenticate the SMB session before every write/scan ([b5b672c](https://github.com/OptimistikSAS/OIBus/commit/b5b672c839d9e407bcf73e9129d92a29ae29a1cc))
* **proxy:** add authentication for proxy server ([3f982f6](https://github.com/OptimistikSAS/OIBus/commit/3f982f6c3310fd2323e437601a02556c978cb184))
* **proxy:** forward requests to upstream proxy ([a7b4a1f](https://github.com/OptimistikSAS/OIBus/commit/a7b4a1fe2fa875968f3f11544948afe55e2cc52b))
* **simu:** simulate data for influx v2 and postgre ([09a9b10](https://github.com/OptimistikSAS/OIBus/commit/09a9b1087e33e009367d1a354583d89eaaa4bd9f))
* **south,north:** add SMB auth for network shares ([ff52723](https://github.com/OptimistikSAS/OIBus/commit/ff52723c9b2436bd61090f3910d42007214bd933))
* **south:** add connection and query duration in test item ([5c96a53](https://github.com/OptimistikSAS/OIBus/commit/5c96a53579612171a19dba202bfbc4c782eb7bfd))
* **south:** add connection and query duration in test item for all connectors ([45cbbe9](https://github.com/OptimistikSAS/OIBus/commit/45cbbe91d5b9b5156663c13ffd9d5612f932bd15))
* **south:** add persistent connection with auto-reconnect to ftp and sftp ([04e2c02](https://github.com/OptimistikSAS/OIBus/commit/04e2c02f465ad474c59102b6bef38ea09cc2af27))
* **south:** add recovery strategy for historian reconnection gap fill ([1f9663d](https://github.com/OptimistikSAS/OIBus/commit/1f9663db109ff887b3d9c53d873223c4bcc30691))
* **south:** replace overlap with startTimeOffset and endTimeOffset ([d8a6d85](https://github.com/OptimistikSAS/OIBus/commit/d8a6d850c67024254a712d8b43968e79667e00d5))
* **south:** show transformed test result and reset stale display mode ([34b1f2a](https://github.com/OptimistikSAS/OIBus/commit/34b1f2a6e4103e6df145e3bfa2e7a15aed305564))
* **south:** test item through north transformer ([064d0c3](https://github.com/OptimistikSAS/OIBus/commit/064d0c3e56f690802610d8da61d73d14b6c90105))
* **transformer:** create a north / history transformer from an existing one ([b1c6643](https://github.com/OptimistikSAS/OIBus/commit/b1c66438c514e99a7240097ea314dc18d66deef3))
* **transformers:** add QueryStartTime and QueryEndTime variables in CSV transformer filename ([3c4f2cc](https://github.com/OptimistikSAS/OIBus/commit/3c4f2ccbdb05d5ba8c75d57f6eebe8cf8448f678))
* **transformers:** test a north/history transformer via a raw→transformer→output pipeline ([c345bba](https://github.com/OptimistikSAS/OIBus/commit/c345bbaf772f214901602a82aa3ac710368206df))
* **transformer:** test transformer with items and fix return dto in oia ([30391b1](https://github.com/OptimistikSAS/OIBus/commit/30391b16f70b741fc6fec5c60f3a0bbdc68425ea))


### Bug Fixes

* **ads:** stop testConnection/testItem from mutating the live client ([0b82b97](https://github.com/OptimistikSAS/OIBus/commit/0b82b977ad1b89102a60ea3bb2844a577227f068))
* **engine:** manage cron from engine instead of north/south connectors ([03bbc76](https://github.com/OptimistikSAS/OIBus/commit/03bbc761240a1d5dde1606f5d43d05b157437e85))
* **engine:** simplify and reword some south/north methods ([6375fb9](https://github.com/OptimistikSAS/OIBus/commit/6375fb90334bbc7c2e4becde702a1df61cb16407))
* **history-query:** test history query item with transformers ([1a9e378](https://github.com/OptimistikSAS/OIBus/commit/1a9e378a7e4e7c1f88c31e61a75d971af00d3414))
* **history:** improve history list display and filtering ([316fc55](https://github.com/OptimistikSAS/OIBus/commit/316fc558be962fa8576a686c41196b71bcb839ba))
* **history:** trigger history north on scan ([55de642](https://github.com/OptimistikSAS/OIBus/commit/55de6422b9bd6aa4d5e1540bc0dee51009e0b4be))
* **influxdb:** do not write file localy ([d37d6dc](https://github.com/OptimistikSAS/OIBus/commit/d37d6dc4a6de1b41333257eabc5f4bbefd7f6e95))
* **install:** fix install script for default params and document them ([9d9b9c4](https://github.com/OptimistikSAS/OIBus/commit/9d9b9c4ea60505c3815c14049ce814c112f35e8d))
* **install:** fix mass install script and linux install doc ([59c65a4](https://github.com/OptimistikSAS/OIBus/commit/59c65a4da822302b8ea18563423c0a8ac9027e83))
* **install:** fix multiple instance installation with windows wizard ([95b1cac](https://github.com/OptimistikSAS/OIBus/commit/95b1cacb1b2694b00848fbf2f02f9e51cbd4104f))
* **install:** fix variables in Inno Setup scripts ([bc325e2](https://github.com/OptimistikSAS/OIBus/commit/bc325e206520b916a32eccc84c08166afa91e49f))
* **install:** prevent char injections and fix multiple instance installation on linux ([0c35dc9](https://github.com/OptimistikSAS/OIBus/commit/0c35dc963d2153d6516e443158290483f8f16011))
* **install:** prevent char injections and fix multiple instance installation on windows ([8034703](https://github.com/OptimistikSAS/OIBus/commit/8034703b5046a6d6738dad76af1224c1e1e6bd7d))
* **install:** properly escape space char in windows install scripts ([2f27392](https://github.com/OptimistikSAS/OIBus/commit/2f273920de744ba590c69ec0e7daee3aa39356b3))
* **install:** properly remove error and archive folders on uninstall ([d1cc5d1](https://github.com/OptimistikSAS/OIBus/commit/d1cc5d1ce5abd2b08ea3c4e5fedc06021b960f77))
* **logger:** fix ci lint and frontend spec failures ([3001bea](https://github.com/OptimistikSAS/OIBus/commit/3001bea5b03baf48179c13ec6bcc043e376008c5))
* **logger:** fix suggestScopes for internal scopes with null scope_name ([6da408c](https://github.com/OptimistikSAS/OIBus/commit/6da408c1928a5e46c63cf35cb24b891a31732a49))
* **logger:** fix syslog bundle and test with syslog simulator ([276ed33](https://github.com/OptimistikSAS/OIBus/commit/276ed3324379f2700d4cdbcfc13a0715a84659a5))
* **logger:** shutdown syslog transport properly on failure ([f3c97bb](https://github.com/OptimistikSAS/OIBus/commit/f3c97bb4a5f97fad8486686b2307bea9acefea2f))
* **logs:** display ms in log page and improve group/items filtering ([ce1fde6](https://github.com/OptimistikSAS/OIBus/commit/ce1fde6b832703d72c094c200105824ca4be4eb1))
* **logs:** search context depending on log page ([60bfa00](https://github.com/OptimistikSAS/OIBus/commit/60bfa00a19aa8b0ac0c8e89673b5b6edcdded9a7))
* **migration:** add settings in migration for folder scanner, and file writer ([ed4f03c](https://github.com/OptimistikSAS/OIBus/commit/ed4f03cb9651af7350ec587e55fe79ff8e93bc48))
* **migration:** merge 3.9.0 migration ([24645b4](https://github.com/OptimistikSAS/OIBus/commit/24645b42ba23c35f4265ac7273eedde0a8c7391e))
* **migration:** migrate south items linked to groups and transformers ([c652dc0](https://github.com/OptimistikSAS/OIBus/commit/c652dc0af59655ab813d38a2094f1d73ed1018c1))
* **migration:** revert migration-service destroy call ([5cadad0](https://github.com/OptimistikSAS/OIBus/commit/5cadad0dba5e6a2de77f0981e18b0a21217dae27))
* **modbus:** don't destroy live connection on testItem, fix reconnect backoff on directQuery failures ([52f9180](https://github.com/OptimistikSAS/OIBus/commit/52f91808c87861125b300bcfbf21dc12774f4982))
* **mqtt:** stop testItem from disconnecting the connector's live client ([76214a7](https://github.com/OptimistikSAS/OIBus/commit/76214a798092d25a266a415dd2c903f547fdfc8a))
* **north,south:** authenticate the actual SMB share, not IPC$ ([472e70e](https://github.com/OptimistikSAS/OIBus/commit/472e70eec4af6e276be990a9f9b620450f9f67c4))
* **north,south:** clear stale SMB sessions to avoid Windows error 1219 ([afb462f](https://github.com/OptimistikSAS/OIBus/commit/afb462f1ebed31149f58713921e5a60db00bf4e6))
* **north,south:** do not tear down the SMB session after testConnection ([a1fcf85](https://github.com/OptimistikSAS/OIBus/commit/a1fcf85710f5769e1c4f1d307c601d8640c2f75c))
* **oianalytics:** add info in engine details for oianalytics ([3a0ef45](https://github.com/OptimistikSAS/OIBus/commit/3a0ef45f16aa792e8012f352509ae0e29a3cfaeb))
* **oianalytics:** split commands for engine settings ([cb9f1d6](https://github.com/OptimistikSAS/OIBus/commit/cb9f1d687dbee3d5040f1f0c611f0792dbf286e7))
* **opcua:** add max parallel runs in opcua south settings ([4771a25](https://github.com/OptimistikSAS/OIBus/commit/4771a250e522b50a5239e674ab914f6b1257b08f))
* **opcua:** change device error to warn ([821c933](https://github.com/OptimistikSAS/OIBus/commit/821c933e281e033e5eba8d4bbc0285e9c73b74c9))
* **opcua:** improve device error detection with time out ([f4b5f29](https://github.com/OptimistikSAS/OIBus/commit/f4b5f2927f2490904180eb3e4b79bb6a210d3853))
* **pi:** stop testItem/testConnection from disconnecting the live PI session ([9ecf4e2](https://github.com/OptimistikSAS/OIBus/commit/9ecf4e22df06a8ca12d8d963ab82d2089aa2920e))
* **proxy:** add forward proxy fields to EngineProxyCommandDTO and updateProxy query ([d0293a3](https://github.com/OptimistikSAS/OIBus/commit/d0293a3a56215b97136f879f3e0b9be219f32c5b))
* **routes:** remove deprecated tslint comment from generated routes file ([7c9504c](https://github.com/OptimistikSAS/OIBus/commit/7c9504c33ce6bf5d61330d0b79545f1f51bac0a1))
* **sftp:** remove downloaded temp file after sending it raw ([376ca02](https://github.com/OptimistikSAS/OIBus/commit/376ca02edd21a09d237c7a3711292403b66979a9))
* **south/north:** improve connector list display and filtering ([ddfc6b1](https://github.com/OptimistikSAS/OIBus/commit/ddfc6b1700c7538c5b32735c8656a8641fc3c2d0))
* **south:** allow parallel runs in south ([60a7a3a](https://github.com/OptimistikSAS/OIBus/commit/60a7a3a03c0ca87cf77d22f162287f6a27bf339e))
* **south:** fix after rebase group management ([b146d54](https://github.com/OptimistikSAS/OIBus/commit/b146d54dd975709a0a36c4a38dcecf753aba7330))
* **south:** fix group logic with max instant when moving items from group ([9e97b4f](https://github.com/OptimistikSAS/OIBus/commit/9e97b4f13c8dff2dd920ded3072ae96b6fa2f2b3))
* **south:** fix interval generation with recovery strategy and history queries ([f3a76d9](https://github.com/OptimistikSAS/OIBus/commit/f3a76d91576cd6ebbe5f83a3adceabc0a1da50d0))
* **south:** improve display of item and groups history fields ([44da3d8](https://github.com/OptimistikSAS/OIBus/commit/44da3d8e4cffce92306d6743d94127f06a717387))
* **south:** improve ftp and sftp logger ([211559d](https://github.com/OptimistikSAS/OIBus/commit/211559d7d979d4441d7193df7aa087fc8e21f4a6))
* **south:** improve oia and rest logger ([47d89f1](https://github.com/OptimistikSAS/OIBus/commit/47d89f11878f1104b5f71ab22e19dfc5cf31c72e))
* **south:** improve opc and pi logger ([3974944](https://github.com/OptimistikSAS/OIBus/commit/3974944c4c6b917ae4465f19cda0dcfdc0dcf3b4))
* **south:** improve South ADS logger ([d1ae717](https://github.com/OptimistikSAS/OIBus/commit/d1ae7176eedd06ac78d83ed28acfae44a8c8c105))
* **south:** improve South Folder Scanner logger ([3dd42c1](https://github.com/OptimistikSAS/OIBus/commit/3dd42c1c6b4cc339473089986018aff1db5faffd))
* **south:** improve South Modbus logger ([95b4e71](https://github.com/OptimistikSAS/OIBus/commit/95b4e715d5d8cdfbb53a03b1fc1757c5bbf8443f))
* **south:** improve South MQTT logger ([34b30f9](https://github.com/OptimistikSAS/OIBus/commit/34b30f9820b1ee75247013e9599e147920a4536c))
* **south:** improve South OPCUA logger ([e38c5f9](https://github.com/OptimistikSAS/OIBus/commit/e38c5f9eb2a2c3d7ded5e331870db1d052d37393))
* **south:** improve sql-like family logger ([cab4f5a](https://github.com/OptimistikSAS/OIBus/commit/cab4f5a573d58c992606cd1eaeb6b0eacfefe85e))
* **south:** properly guard against empty scan mode with csv import and south update ([83b601d](https://github.com/OptimistikSAS/OIBus/commit/83b601df199043d9ea753fd7412fa844ee8f4d75))
* **south:** properly set default history fields on group and south items ([d134c09](https://github.com/OptimistikSAS/OIBus/commit/d134c095979c2c6a6a1b6d15495e3d5b632db472))
* **south:** properly set group on item imports ([de7440e](https://github.com/OptimistikSAS/OIBus/commit/de7440e6831fd7a27f169e4d0ea2b2ad8c273b47))
* **south:** remove unused deferred promise ([1ef07d8](https://github.com/OptimistikSAS/OIBus/commit/1ef07d8b0946f54183f5236641e2b071fe9eaf9a))
* **south:** reuse existing south for tests if necessary ([9f78a57](https://github.com/OptimistikSAS/OIBus/commit/9f78a57ca4651b795c6da7109fa4d0479c17e9e7))
* **south:** set scan mode to group scan mode when group changes to avoid FK error on scan mode deletion ([8655d34](https://github.com/OptimistikSAS/OIBus/commit/8655d3497c79bb742029a949e96d41a74c9ea5cb))
* **south:** share a single opcua session ([8f4456a](https://github.com/OptimistikSAS/OIBus/commit/8f4456a07f2073ec791b12021ba0385af8020567))
* **south:** simplify groups creation at configuration changes ([b502ffc](https://github.com/OptimistikSAS/OIBus/commit/b502ffc95dc437c702c4f8a66e79c68de31e508e))
* **south:** simplify south cache repo access ([0694e21](https://github.com/OptimistikSAS/OIBus/commit/0694e2199ebc6dec2703789c04232bed1ea13e1c))
* **south:** use properly recovery strategy and tracked instant ([f0340e4](https://github.com/OptimistikSAS/OIBus/commit/f0340e44546a6534f7f94b1408696360b7841fdc))
* switch cmdkey to net command to set remote folder access ([7235f7b](https://github.com/OptimistikSAS/OIBus/commit/7235f7b94e0c32ea0c3f488138871e1622c89d6b))


### Performance Improvements

* **lint:** check formatting with prettier directly instead of via eslint rule ([577691f](https://github.com/OptimistikSAS/OIBus/commit/577691f14433f0e9af29a19cb9cfdfe5a13021a7))
...
* **south-rest:** do not override query params ([e822374](https://github.com/OptimistikSAS/OIBus/commit/e8223743599a9ae1cf478f2e87c9d6fec97ed72e))
...
* **south:** remove file from south-rest cache when sent ([f8a1856](https://github.com/OptimistikSAS/OIBus/commit/f8a1856259532a2f13a0ca31e054c1b1ad13bd1b))
...
* **api:** expose audit fields in REST API controllers and update OpenAPI spec ([e48e713](https://github.com/OptimistikSAS/OIBus/commit/e48e713aeb52a3ff210a0455fbef903f133fa728))
* **audit-fields:** enhanced audit field integration across services and repositories ([0a92870](https://github.com/OptimistikSAS/OIBus/commit/0a92870738610781869731738d61fff18c454331))
* **cache:** add cache filename when displaying content ([8260796](https://github.com/OptimistikSAS/OIBus/commit/8260796b4897c3e99a7861199f1724066bbc3099))
* **cache:** add cache migration ([7ba4b63](https://github.com/OptimistikSAS/OIBus/commit/7ba4b63d648333377fe9ff3e31d2a192ad67e217))
* **cache:** rework cache management from remote oianalytics ([752d647](https://github.com/OptimistikSAS/OIBus/commit/752d6470e2d74aa16c416720fdac3617fa8c8a24))
* **cache:** rework engine and cache management ([e770345](https://github.com/OptimistikSAS/OIBus/commit/e7703450c237256e9fa3af5080d3a066ef4e5d6a))
* **connectors:** added OIBusConnectionTestResult interface and updated testConnection methods across connectors to return structured results ([466a65d](https://github.com/OptimistikSAS/OIBus/commit/466a65d714de402b7f873e4b3c9388c144d3ca51))
* **data-stream:** clear proxy agent cache on stopping history queries ([cd82218](https://github.com/OptimistikSAS/OIBus/commit/cd82218d2dc7a89340df71953d04d9cb51a2119f))
* **engine:** implemented redirect with modal on port change ([368d2b0](https://github.com/OptimistikSAS/OIBus/commit/368d2b0e4b82c3535e3a37659f8ded014797bf9a))
* **engine:** update history query engine and south connector infrastructure for audit fields ([4294ba4](https://github.com/OptimistikSAS/OIBus/commit/4294ba4f56abfad5f97520cef6154f0406016e53))
* **entities:** add createdAt and updatedAt to shared models and database migration ([db89291](https://github.com/OptimistikSAS/OIBus/commit/db89291b3bc773d51ce6e48742f24b5438cbc322))
* **entities:** added createdBy and updatedBy fields to all entities ([206fc0f](https://github.com/OptimistikSAS/OIBus/commit/206fc0f7af627f1c18f578ba9e01c994ef15614f))
* **entities:** added createdBy, updatedBy, createdAt, updatedAt to all entity DTOs ([586a199](https://github.com/OptimistikSAS/OIBus/commit/586a19904770b10f0a5ff737698c79141a8b68f5))
* **frontend:** display audit fields in entity list components ([4733baf](https://github.com/OptimistikSAS/OIBus/commit/4733baf125d95dbde68ea8a40dfaa3c0957544fa))
* **history-query:** display interval start and end on detail page ([2160ba6](https://github.com/OptimistikSAS/OIBus/commit/2160ba68d8f00f106c9826aec31400b86d77a923))
* **http-request:** implemented ProxyAgent caching and added tests for proxy reuse ([d2a41eb](https://github.com/OptimistikSAS/OIBus/commit/d2a41eb7feb094b92bdada683652f81c092d7b8e))
* **item:** added 'enabled' property to item models and updated related code ([8bfb76e](https://github.com/OptimistikSAS/OIBus/commit/8bfb76e4300db3ad3e232d79b6f12f47a55d7f10))
* **manifest-builder:** implemented manifest attribute editor modal with dynamic form handling and validation ([189c798](https://github.com/OptimistikSAS/OIBus/commit/189c798c4c8b928d03759605373575da61ccc5c5))
* **modbus:** query modbus addresses in batch ([1f55c64](https://github.com/OptimistikSAS/OIBus/commit/1f55c64b5d72abd95e9ed4e7eb7c392cc489600c))
* **mqtt:** improve mqtt south connector to manage any content and improve custom transformer sandbox ([ed840fe](https://github.com/OptimistikSAS/OIBus/commit/ed840fe434121106736c0c52b6abd116fdbbe83c))
* **oianalytics:** added cache content management commands and proper permissions ([dedf0dd](https://github.com/OptimistikSAS/OIBus/commit/dedf0ddc600d8b229ed6c64630184d2a024e43b8))
* **oianalytics:** implemented shared test connection feature for OIAnalytics registration ([cccb216](https://github.com/OptimistikSAS/OIBus/commit/cccb216471bb17f0c85f631d8da9bc8d42c3c76a))
* **repositories:** persist and retrieve audit fields in all config repositories ([5a93797](https://github.com/OptimistikSAS/OIBus/commit/5a9379772a99f76766d044d0331830825164da43))
* **rest-api:** improve forms and transformers ([cee110d](https://github.com/OptimistikSAS/OIBus/commit/cee110db0ff0120c2ed491b5f9c67fa2025b335e))
* **rest:** improve north rest connector ([146dab3](https://github.com/OptimistikSAS/OIBus/commit/146dab37216af2b9dbe465c9c8cc89325dc7df7a))
* **services:** propagate audit fields through all services and DTO converters ([85761dc](https://github.com/OptimistikSAS/OIBus/commit/85761dc5e3b6072664e86f1a42886f54e5b9c5a1))
* **south-rest-api:** added API key authentication support with header and query parameter options ([beb093e](https://github.com/OptimistikSAS/OIBus/commit/beb093e462d937fe66155969d64bf9ad9f7ac811))
* **south-rest-api:** added enabling conditions for dynamic form behavior and enhanced date-time handling in settings ([84cc16f](https://github.com/OptimistikSAS/OIBus/commit/84cc16f14a1c67b9d4fdcc388844cb1e80bb4915))
* **south/history-query:** added sort and filter options for items and inlined history query item management ([d0fd38c](https://github.com/OptimistikSAS/OIBus/commit/d0fd38cb63cbd02cb48a781e3ae66bc78783feb3))
* **south:** add groups in south command to manage groups like items ([c5995f1](https://github.com/OptimistikSAS/OIBus/commit/c5995f11f918f084200577b28d27190027b0cbe9))
* **south:** added maxFiles, maxSize, and recursive options to FTP, SFTP, and Folder Scanner connectors ([2e3a7f8](https://github.com/OptimistikSAS/OIBus/commit/2e3a7f8a0ffac7c597aac55b9368b25f8e5e8215))
* **south:** added view item value modal with display for last value, query time, and tracked instant ([f179c79](https://github.com/OptimistikSAS/OIBus/commit/f179c7998f1c065dbb52aebd1d3e361d0f5fe545))
* **south:** implemented item grouping functionality with CRUD operations for South item groups ([2fd6460](https://github.com/OptimistikSAS/OIBus/commit/2fd64609eafdfac7c5986855feed2fdea2b64565))
* **south:** implemented proper item cache management and last value storage in SouthConnector ([9a7ac14](https://github.com/OptimistikSAS/OIBus/commit/9a7ac1455e4577dcbca8d50461e488fd6d4d2fb1))
* **south:** new south rest api connector ([cd14156](https://github.com/OptimistikSAS/OIBus/commit/cd14156848708de3d77c7e877950ba2f43c27b2c))
* **south:** query group items ([10dd22f](https://github.com/OptimistikSAS/OIBus/commit/10dd22fca5e4d865653563d415f7cbdf7877c57d))
* **tests:** added confirmation service mock to EditTransformerModalComponent tests ([7e87f0c](https://github.com/OptimistikSAS/OIBus/commit/7e87f0cf415c7a07772bd797587e9564ffa93ded))
* **transformer:** add testing functionality for custom transformers ([089e14f](https://github.com/OptimistikSAS/OIBus/commit/089e14f6e2b3ddf8c2fec5fcb211620490a329aa))
* **transformer:** added group support for transformers and updated related models ([c4ef415](https://github.com/OptimistikSAS/OIBus/commit/c4ef415673507cd0f83b80094cb25176c393fce6))
* **transformer:** create and update custom transformer from engine ([fbb3838](https://github.com/OptimistikSAS/OIBus/commit/fbb38380f13659245c237cc4450ca184658d8571))
* **transformer:** create new transformers (json, csv...) ([a84666e](https://github.com/OptimistikSAS/OIBus/commit/a84666ebcd331baf379a82a583d5054740113746))
* **transformer:** enhanced transformer modal with creation mode support and code template generation ([1ea2304](https://github.com/OptimistikSAS/OIBus/commit/1ea2304d56012305a101d89e390dd608ad82239c))
* **transformer:** implemented TypeScript support for custom transformers ([9625f91](https://github.com/OptimistikSAS/OIBus/commit/9625f91b625b8ca1638753ad6274a94a871d260c))
* **transformer:** manage python custom transformer ([3b06c0c](https://github.com/OptimistikSAS/OIBus/commit/3b06c0c5d7967f501ba0194453e07f4143405ac4))
* **transformers:** add items associated to transformers (data model) ([6bd7d44](https://github.com/OptimistikSAS/OIBus/commit/6bd7d442a8949b431ad072b35fdeca68b031fd1e))
* **transformers:** added timeout property to custom transformers and updated related components ([f6634a7](https://github.com/OptimistikSAS/OIBus/commit/f6634a71c148c4c6f0a44486f238b0ffd4313df9))
* **transformers:** added transformer manifest management with API endpoints for listing and retrieving manifests ([fe84220](https://github.com/OptimistikSAS/OIBus/commit/fe84220cd4651ff9637b42b04307129f3e972f49))
* **transformers:** added TransformerTestResponse schema and updated test endpoint to return response ([fd2c8db](https://github.com/OptimistikSAS/OIBus/commit/fd2c8db38e30d34c7c0203cd2432cd6f061eed13))
* **transformer:** select by south and group, not by data type ([f17dfc2](https://github.com/OptimistikSAS/OIBus/commit/f17dfc2638bfdad4f789bc0a6be50d5e373800bd))
* **transformers:** enhanced item selection with 'select all' functionality and dynamic search results ([d735074](https://github.com/OptimistikSAS/OIBus/commit/d735074225ecbf9c351c92c6d0e0e7f07d4da0fe))
* **transformers:** enhanced manifest attribute editor with nested attributes handling and context-aware modal interactions ([68fbcb3](https://github.com/OptimistikSAS/OIBus/commit/68fbcb39f37900853e234d8ae5a871cf483dbb01))
* **transformer:** show item name and count with tooltip in transformer source column ([a13f4ac](https://github.com/OptimistikSAS/OIBus/commit/a13f4acd3d20f3eaa115ef38dcf2772d4b1b62df))
* **transformers:** implemented enhanced item search and selection with dropdown functionality and improved tests ([3db8afc](https://github.com/OptimistikSAS/OIBus/commit/3db8afc999a8d1d5b046528b823c1261c8e77728))
* **transformers:** integrated confirmation service for editing transformers and updated confirmation messages ([480d7f8](https://github.com/OptimistikSAS/OIBus/commit/480d7f88c884a739ac2e918faf3afc8576161445))
* **transformers:** remote crud from OIAnalytics for custom transformers ([893882a](https://github.com/OptimistikSAS/OIBus/commit/893882a9a2f444a51d12ea5b007d438cf02a5a13))
* **transformers:** remove subscriptions and implement it in transformers ([d8f60e8](https://github.com/OptimistikSAS/OIBus/commit/d8f60e88e0775adb8670d0d4328352e2cfc667cf))
* **transformers:** rework transformer selection ([5293022](https://github.com/OptimistikSAS/OIBus/commit/5293022b52eb527f5a782bfdeefca461346dd1f5))
* **transformers:** select items to apply the transformer ([6ed674d](https://github.com/OptimistikSAS/OIBus/commit/6ed674d3f98f59191056b25aea4cc985f55a5fc3))
* **transformers:** select items to apply the transformer ([b48dafb](https://github.com/OptimistikSAS/OIBus/commit/b48dafbee83f5ef14c10a1b6958976a49215191c))
* **user-service:** handled null userId in getUserInfo method and added corresponding test case ([dae3215](https://github.com/OptimistikSAS/OIBus/commit/dae3215d8e3d5aa6370cb58efbe87adb80322115))
* **versioning:** implemented version monitoring and update notification in app component ([7bebec2](https://github.com/OptimistikSAS/OIBus/commit/7bebec29f936bced9ca7bcc7a9c66d3c9debccd1))


### Bug Fixes

* **cache:** do not block caching for each north ([ba22be9](https://github.com/OptimistikSAS/OIBus/commit/ba22be92d96f73491489bf2d5cf89c5aeccfc0b4))
* **cache:** fix null groupId SQL comparisons in deleteItemValue and saveItemLastValue ([df19668](https://github.com/OptimistikSAS/OIBus/commit/df196686b3689eb98c180432e3aa5c504bd3c89b))
* **cache:** improve cache service performance ([eecc8da](https://github.com/OptimistikSAS/OIBus/commit/eecc8dafc744d4f128d6ff52a9a38cda950a408c))
* **cache:** improve cleanup cache service performance ([be0b72c](https://github.com/OptimistikSAS/OIBus/commit/be0b72cdcd59efc63f02fc7642485e583aef8c09))
* **code:** replace monaco editor by codemirror and fix item test display with mqtt ([d0ce9c5](https://github.com/OptimistikSAS/OIBus/commit/d0ce9c52b69248a0e9b1dbd20105acad983dd357))
* display "ok" button when modal closing does not save directly the entity ([8e825a9](https://github.com/OptimistikSAS/OIBus/commit/8e825a99038f0ac9db10f95827e2e4220ad91a4f))
* display of date tme and date range selectors ([bfecd21](https://github.com/OptimistikSAS/OIBus/commit/bfecd211fc05a0eaf997ff0630dc24ee776f95bb))
* **docker:** fix mqtt simulator docker ([9c44b16](https://github.com/OptimistikSAS/OIBus/commit/9c44b16b748f400603a9dffb0c06c65f3a1cec87))
* fix custom transformers after rebase ([0fadc31](https://github.com/OptimistikSAS/OIBus/commit/0fadc31a873d512290af43010582d4a9ee51a60a))
* **frontend:** fix vitest spec failures after migration ([4c1b8a0](https://github.com/OptimistikSAS/OIBus/commit/4c1b8a06c0b8bcfbe8b410ae3625f674d125be1a))
* **frontend:** mock engineService.info$ in app component spec ([c00feeb](https://github.com/OptimistikSAS/OIBus/commit/c00feeb692c986e0f901a46c1e5afb3851dcb6cc))
* **history-query:** fix transformer creation and edition for history queries ([3da2f90](https://github.com/OptimistikSAS/OIBus/commit/3da2f90be6b800f31978254fe2d5f244594f2bc7))
* **history-query:** return command dto from item modal to fix 422 on create ([2e2924c](https://github.com/OptimistikSAS/OIBus/commit/2e2924c58978ce8eb860b9e5d76007b8e41b6af7))
* **history:** added max read interval and read delay in dtos ([886440b](https://github.com/OptimistikSAS/OIBus/commit/886440b5b9c2ccdf0b72a48b0119663fbc71cafa))
* **install:** fix install script and disk image creation documentation ([d578052](https://github.com/OptimistikSAS/OIBus/commit/d5780524f93856618c6aa2c02e013c0ffbd2aee9))
* **ip-filter:** improve ip filters regex ([77cac1f](https://github.com/OptimistikSAS/OIBus/commit/77cac1feda8104d88a6a7f42d723896bcb625055))
* **items:** properly export and import items for south and history ([160d942](https://github.com/OptimistikSAS/OIBus/commit/160d9427ac661b00f501fea1d5f76de62d2d7382))
* **logger:** improve pino logger performance ([6adaed1](https://github.com/OptimistikSAS/OIBus/commit/6adaed16f7e1a3f21f9c2ee92c2d5cc1728fc3d3))
* **logs:** add index on logs table to improve query performances ([4934318](https://github.com/OptimistikSAS/OIBus/commit/493431891d4003b2300e354e3a0a319cf4148545))
* **logs:** improve vacuum and log deletion on log database ([a11dcae](https://github.com/OptimistikSAS/OIBus/commit/a11dcaec8223e731eb118037a2b1e56e7ddea6b2))
* **logs:** remove old journal.log files ([a28f396](https://github.com/OptimistikSAS/OIBus/commit/a28f3966c40f675956078c9a000a9bb8563797cb))
* **metrics:** improve metrics perf ([5a2bba3](https://github.com/OptimistikSAS/OIBus/commit/5a2bba3e2773ba656fe49975d18b0aba3d2bc23e))
* **migration:** auto group items from south connectors ([9470fc5](https://github.com/OptimistikSAS/OIBus/commit/9470fc51586e5726ac5e921bc4f5faf37f4487c0))
* **migration:** fix cache migration edge cases ([0afe813](https://github.com/OptimistikSAS/OIBus/commit/0afe81321d95632912e83b42d5786ee137f16221))
* **migration:** fixed migration when reading folders that does not exist while migrating data folder ([94247f3](https://github.com/OptimistikSAS/OIBus/commit/94247f3f72abde5d163349c03179ef7025a55587))
* **migration:** improve migration to 3.8 ([285e4b3](https://github.com/OptimistikSAS/OIBus/commit/285e4b350c5782e724fc0bf2e7dd71b5952417a0))
* **migration:** set english label in custom manifest ([179b18d](https://github.com/OptimistikSAS/OIBus/commit/179b18d1dbba038e36a8446784f96ee6abda75c1))
* **migration:** split batch insert in chunks of 100 rows (SQLite limit of 500) ([caf305c](https://github.com/OptimistikSAS/OIBus/commit/caf305cfd739236d4b72654fef3bf15a70099b71))
* **modbus:** add batchQuery boolean setting in south modbus ([26d67ad](https://github.com/OptimistikSAS/OIBus/commit/26d67ad86193f80805f9545bac6b594309b07af4))
* **modbus:** add keep alive for modbus socket ([53ad566](https://github.com/OptimistikSAS/OIBus/commit/53ad566976fa6527efcdc77eb834e4600ee3b0a3))
* **modbus:** improve test connection details ([5814b29](https://github.com/OptimistikSAS/OIBus/commit/5814b292dbbcde687282bd4128178bce449cd122))
* **mqtt:** improve test connection details ([c132c96](https://github.com/OptimistikSAS/OIBus/commit/c132c96a6c96b48bb474a3ec84db940a5782af86))
* **north-rest:** remove form data to match undici buffer and remove form data dep ([9814930](https://github.com/OptimistikSAS/OIBus/commit/981493001b38e4902143d709c40ba5f30812f9c9))
* **north:** fix north transformer creation and edition ([c1ea59b](https://github.com/OptimistikSAS/OIBus/commit/c1ea59beefe307530749f5320094ad7bc228453c))
* **north:** fixed north transformer repository ([9f64bef](https://github.com/OptimistikSAS/OIBus/commit/9f64bef1fed175b019cf245074225c608999ffa6))
* **north:** properly chunk data when slicing per number of elements ([c0c817b](https://github.com/OptimistikSAS/OIBus/commit/c0c817bea2e94159107a6663fb95594f8d990643))
* **odbc:** fix odbc dynamic import ([b4fa600](https://github.com/OptimistikSAS/OIBus/commit/b4fa600d1441ec61f2b89c514cb10884ab1c2780))
* **oianalytics:** fix commands retrieval and ack on network failure ([918efa8](https://github.com/OptimistikSAS/OIBus/commit/918efa82a741caeb03b27e87e1ed29804b88cb5d))
* **oianalytics:** fix compression of values for north OIAnalytics ([239c0ef](https://github.com/OptimistikSAS/OIBus/commit/239c0ef2b792c80574fc59ee327f0c68887210d5))
* **oianalytics:** fix registration, message and command services with oianalytics ([2bef852](https://github.com/OptimistikSAS/OIBus/commit/2bef852d7499d610a970f04830dcea3bf0fa97b2))
* **oianalytics:** fixed OIAnalytics connection test when not registered ([0764360](https://github.com/OptimistikSAS/OIBus/commit/0764360f5d6b01b293cdc7a4e013f1590d9b53f8))
* **oianalytics:** proper items and groups model in south connectors sent to OIAnalytics ([1755867](https://github.com/OptimistikSAS/OIBus/commit/1755867fb875423f7e8ba2f7fb4d728e19e5ab49))
* **oianalytics:** proper items and groups model in south connectors sent to OIAnalytics ([186ff83](https://github.com/OptimistikSAS/OIBus/commit/186ff8340c22cd357703fd166b5b70527e43c116))
* **oianalytics:** properly send file as stream with undici ([5623634](https://github.com/OptimistikSAS/OIBus/commit/5623634d4478a60a5075d6bb51dc3cada63094ec))
* **oianalytics:** send OIBus audit fields to OIAnalytics ([f12b644](https://github.com/OptimistikSAS/OIBus/commit/f12b6441aa30ea980adee83f552a90908267a0dd))
* **opcua:** improve test connection details ([dd18de3](https://github.com/OptimistikSAS/OIBus/commit/dd18de37d61301679b3458d5dd044611a8c7d0a3))
* **opcua:** remove shared connection settings ([c68f85d](https://github.com/OptimistikSAS/OIBus/commit/c68f85dc4cfb8a3cb7fa17d04d7f768a868fbd4e))
* **pagination:** moved pagination component to the bottom of the lists in certificate, IP filter, scan mode, and transformer components ([ebb49cd](https://github.com/OptimistikSAS/OIBus/commit/ebb49cd91e2b520ac6d3ca5ca920ea1b1113f9df))
* **south-odbc:** use require() instead of import() in odbc-loader for testability ([fa56adc](https://github.com/OptimistikSAS/OIBus/commit/fa56adc0238fc9afec2bac37df90f4b564deca8f))
* **south-odbc:** use top-level static import in odbc-loader ([a666aca](https://github.com/OptimistikSAS/OIBus/commit/a666aca3d5dc706e9e8b7084ce1eb828c5748197))
* **south-rest:** fix settings for south rest connector ([fc8365c](https://github.com/OptimistikSAS/OIBus/commit/fc8365cadd371e76bf47b057fdcdce5c6440c578))
* **south/folder-scanner:** populate filesPreserved in v3.8.0 migration instead of connector fallback ([4f179b8](https://github.com/OptimistikSAS/OIBus/commit/4f179b8717bb52fc8f650f8d58a93eed390d3664))
* **south/folder-scanner:** use tracked_instant as cutoff after 3.7 migration ([d3224e8](https://github.com/OptimistikSAS/OIBus/commit/d3224e8d3b44ec6225e5052fbd967849400d4a5d))
* **south:** adapt add content on subscriptions with new metadata sources ([63bd05e](https://github.com/OptimistikSAS/OIBus/commit/63bd05eed5cdce4b10989885a0a807673dbdeebf))
* **south:** add rest-api type in dto after rebase ([2ac61d6](https://github.com/OptimistikSAS/OIBus/commit/2ac61d6e8cd5ce07728c552888824e2542d9ba2f))
* **south:** added tests for creating south connector with historian values and converting to DTO with non-empty groups ([e84a707](https://github.com/OptimistikSAS/OIBus/commit/e84a7073be09cd0b2d3c94dc5f0df770951ff418))
* **south:** allow maxReadInterval readDelay overlap syncWithGroup columns in csv import ([b67d92c](https://github.com/OptimistikSAS/OIBus/commit/b67d92ccebb49383ef7cdb5a1154e107e6a1cddd))
* **south:** cache value from item id, group id not mandatory ([00b5be9](https://github.com/OptimistikSAS/OIBus/commit/00b5be97bd0c859a7310d082b4f1c449c5e85bc3))
* **south:** create group on backend before moving items in mass action ([190acd0](https://github.com/OptimistikSAS/OIBus/commit/190acd09f3fdbc71bef41bf851c135ebb8e74114))
* **south:** export group historian settings as fallback in csv when item values are null ([57836b3](https://github.com/OptimistikSAS/OIBus/commit/57836b3639d2f9336eefca16bf47d69e609dbfcb))
* **south:** export maxReadInterval readDelay overlap syncWithGroup in csv ([6239558](https://github.com/OptimistikSAS/OIBus/commit/6239558c4ef533e7811ddd909f6fcd9cb537dbd6))
* **south:** fix preserved files migration for file connectors ([69f855a](https://github.com/OptimistikSAS/OIBus/commit/69f855a1bcdf5459aabb10b0363dac49f2e0083b))
* **south:** fix translation and add condition operator ([25406c6](https://github.com/OptimistikSAS/OIBus/commit/25406c6f9d0c493e95f61ee4b162a139d970a7fb))
* **south:** fix update cron jobs ([8425411](https://github.com/OptimistikSAS/OIBus/commit/842541144cab0b6a20d86533b10f9067003421dd))
* **south:** improve group by items performance ([f543186](https://github.com/OptimistikSAS/OIBus/commit/f5431860afb74ce1081a498f7734d4493af3e034))
* **south:** improve mqtt wildcards match to items performance ([bdc742d](https://github.com/OptimistikSAS/OIBus/commit/bdc742d05477a68b6d4e728010b20308e382cd8b))
* **south:** improve performance when querying south items ([cd5d3b8](https://github.com/OptimistikSAS/OIBus/commit/cd5d3b8a0d19edd8274c8916c8008f8ba10b16dc))
* **south:** improve south cache perf ([2f85997](https://github.com/OptimistikSAS/OIBus/commit/2f85997518470fa92dca0bdc0d92c9e02360068a))
* **south:** improve south mqtt flush message performance ([2ea2f26](https://github.com/OptimistikSAS/OIBus/commit/2ea2f269e8b533af39ccc11beb38283be629ab86))
* **south:** improve south opcua flush message and ha performance ([11cce96](https://github.com/OptimistikSAS/OIBus/commit/11cce9664d8d8caaf134cb2a20ee240a77333010))
* **south:** improve user experience when loading last item value ([6445861](https://github.com/OptimistikSAS/OIBus/commit/644586193f4c5943466de0474e81013ce7ff2d34))
* **south:** items can be linked to only one group ([03d86ad](https://github.com/OptimistikSAS/OIBus/commit/03d86ada65a9e6e79f359723b3553e10c9da1865))
* **south:** make update subscriptions clearer ([c7b963e](https://github.com/OptimistikSAS/OIBus/commit/c7b963e095f89e6ae8643510044a9981c09a8ee8))
* **south:** preserve group historian values when duplicating south connector ([1c51dfb](https://github.com/OptimistikSAS/OIBus/commit/1c51dfb846671e9b3ba95515fb5186c1db628e21))
* **south:** preserve group name through csv import check ([d52272f](https://github.com/OptimistikSAS/OIBus/commit/d52272fa835dac572c0dfd6fa2fcbfc5cfbe2cf0))
* **south:** properly add new groups from south edition ([24b9603](https://github.com/OptimistikSAS/OIBus/commit/24b96033fc456d717bf1ff1e9a5e0375e629f4db))
* **south:** properly display group / historian settings on items group overlay ([27df097](https://github.com/OptimistikSAS/OIBus/commit/27df097f9d3c518de87745a9e0bab2e59ec721da))
* **south:** properly group items ([d550333](https://github.com/OptimistikSAS/OIBus/commit/d55033319d2302995667191e1e86e6d0b511d9ec))
* **south:** properly reload items on south group scan mode update ([c10d929](https://github.com/OptimistikSAS/OIBus/commit/c10d92924cc12b7214a3997da609528a2bab9cb7))
* **south:** properly reload items on south group scan mode update from edit south ([ff506dd](https://github.com/OptimistikSAS/OIBus/commit/ff506dd7357301f5003fbfa625779adf9ee19291))
* **south:** properly retrieve HA values for OPCUA ([1812ed3](https://github.com/OptimistikSAS/OIBus/commit/1812ed37c965bcb50ef11e51d78ee519f79b5884))
* **south:** properly stop south when querying history ([8bec5fe](https://github.com/OptimistikSAS/OIBus/commit/8bec5fe63f8c4356b3248f380f50b5886c2e0a3c))
* **south:** show group name in csv import preview ([50b5c16](https://github.com/OptimistikSAS/OIBus/commit/50b5c16669a9d2c70f477a42a9497b95831b96fc))
* **test-connection:** send test connections details to OIAnalytics ([dd976d8](https://github.com/OptimistikSAS/OIBus/commit/dd976d860bd5f16a09549c3a4e5cb352e4ae4cb1))
* **tests:** align cache specs with 2-arg getItemLastValue/deleteItemValue API after rebase ([bc7475a](https://github.com/OptimistikSAS/OIBus/commit/bc7475aef1e0b58dc76f4a8086506c907fd1b5bd))
* **tests:** align south-connector error message assertions with current production strings ([c65a989](https://github.com/OptimistikSAS/OIBus/commit/c65a9892f08b98a0f0fac2319f95296746cbefd7))
* **tests:** ensured database connections are closed and Jest fake timers are reset in spec files ([89b46dc](https://github.com/OptimistikSAS/OIBus/commit/89b46dc9b24c73572a246581124fd5f0b7d048d5))
* **tests:** fix ci failures in transformer, metrics, and mqtt specs ([5077d48](https://github.com/OptimistikSAS/OIBus/commit/5077d48db75726d107e4748a1d499e41fa2ff3e9))
* **tests:** fix ts errors, eslint issues and broken specs ([27bff08](https://github.com/OptimistikSAS/OIBus/commit/27bff084addc57eb7bc4f36df0029d91e7442c0b))
* **tests:** reset Jest timers in afterEach hooks across multiple spec files ([8acce3b](https://github.com/OptimistikSAS/OIBus/commit/8acce3b524a35e6887b699321d3044ec28889e51))
* **tests:** resolve typescript and lint errors ([30ed5c3](https://github.com/OptimistikSAS/OIBus/commit/30ed5c3592c3be85774862c9a1188bd9483f98ca))
* **tests:** resolve TypeScript errors in spec files and transformer mock ([cf20094](https://github.com/OptimistikSAS/OIBus/commit/cf20094ffe0d116ce6fc551112203c34efab9a8a))
* **transformer:** add field process for json transformers ([b31793b](https://github.com/OptimistikSAS/OIBus/commit/b31793be49c345915a611d984a5789c30c9a546e))
* **transformer:** bundle custom transformers ([6820535](https://github.com/OptimistikSAS/OIBus/commit/68205354bdbaae737abf275901000df29effaf2c))
* **transformer:** change default settings for csv converter ([75afb75](https://github.com/OptimistikSAS/OIBus/commit/75afb750f71c0d81d3b73791297677db738c89ae))
* **transformer:** fix content controller body type ([263c2a9](https://github.com/OptimistikSAS/OIBus/commit/263c2a97f0fe43648647389c077d727f1a177873))
* **transformer:** fix custom transformer code execution tests ([a5b3595](https://github.com/OptimistikSAS/OIBus/commit/a5b35952e0dc4965c11fab38b027a5d81ebbcc13))
* **transformer:** fix json path source path ([b744fba](https://github.com/OptimistikSAS/OIBus/commit/b744fba7365cb9b919f86c2698a0f863b5faea85))
* **transformer:** fix log and display ([803b216](https://github.com/OptimistikSAS/OIBus/commit/803b2163eafc09c29c6a348c941771cee9c5304d))
* **transformer:** guard against undefined value in csv import for object-type fields ([44a7cb8](https://github.com/OptimistikSAS/OIBus/commit/44a7cb82b9c5c829b310547f181848bf8c107ea2))
* **transformer:** improve transformer test display and fix sandbox execute call ([f7c605e](https://github.com/OptimistikSAS/OIBus/commit/f7c605e6524dee2371e43d88af6141051198fa8f))
* **transformer:** improve transformers performance ([8426ea9](https://github.com/OptimistikSAS/OIBus/commit/8426ea9cf5286b7f72cefba8fc572e07568b2585))
* **transformer:** improve user experience when testing transformers ([646433d](https://github.com/OptimistikSAS/OIBus/commit/646433dc35361bf06ac5e8fc962594e3cf79d968))
* **transformer:** improve user experience when testing transformers ([a797f10](https://github.com/OptimistikSAS/OIBus/commit/a797f10d72f7895dbd1d10efccb0f2d33ad608df))
* **transformer:** properly filter any-content transformers ([4126e00](https://github.com/OptimistikSAS/OIBus/commit/4126e00776565d08fc8ab0a1616799278102da61))
* **transformer:** properly filter selectable outputs ([6287df7](https://github.com/OptimistikSAS/OIBus/commit/6287df74c6189fe687fb43afec80219a3745f3c1))
* **transformer:** properly manage stringified json on retrieved payload ([a2e4bcb](https://github.com/OptimistikSAS/OIBus/commit/a2e4bcb294d50f9a25f3588587d2f470d1977d88))
* **transformer:** properly retrieve audit fields and set them in migration ([74d5363](https://github.com/OptimistikSAS/OIBus/commit/74d5363765f31a1957ba0a43e7961d4275088683))
* **transformer:** remove default line delimiter for csv transformers ([9425957](https://github.com/OptimistikSAS/OIBus/commit/94259577e9a23acd07de6e98c2f3e05bff68ad81))
* **transformer:** remove pyodide and python language for custom transformer ([24eb764](https://github.com/OptimistikSAS/OIBus/commit/24eb764765d775f5fb9da96e4528b6cd41ad90c0))
* **transformer:** retrieve north transformer once at connector startup ([628f85b](https://github.com/OptimistikSAS/OIBus/commit/628f85b4bd1e80d47f0d81a932d86bcf00ff1b05))
* **transformers:** adapt standard transformers ([bc94fa0](https://github.com/OptimistikSAS/OIBus/commit/bc94fa09b25d311994a172c4cc114d7975fb9aa9))
* **transformers:** adapt standard transformers ([cfa0381](https://github.com/OptimistikSAS/OIBus/commit/cfa0381725715050c5f4ac2afde7abd7170bbccc))
* **transformers:** enhanced transformer service with reload capabilities for custom transformers ([58cb507](https://github.com/OptimistikSAS/OIBus/commit/58cb507cfd7b3f819f3e0fe10b1b597b038dcaa0))
* **transformers:** fix transformers settings from manifest ([8ed486f](https://github.com/OptimistikSAS/OIBus/commit/8ed486ff936fc42848a95eb196041305632f0929))
* **transformers:** improved item selection logic and refresh search results in edit transformer modal ([704c66b](https://github.com/OptimistikSAS/OIBus/commit/704c66bec2befe45c6edf6ffe0eb17160145bd23))
* **transformers:** properly remove transformers on edit / creation mode ([5316be5](https://github.com/OptimistikSAS/OIBus/commit/5316be5ffce899adf5d38fdfb2836596773b8fdc))
* **transformers:** updated createDefaultTransformers function to await database queries for transformer existence checks ([aa4af26](https://github.com/OptimistikSAS/OIBus/commit/aa4af26daa49924491189e37984d57c9fa2d80c4))
* **transformer:** update model api for transformers ([c4a1891](https://github.com/OptimistikSAS/OIBus/commit/c4a1891f4c76ab871c24973ee6023e2e8d964678))
* **transformer:** use buffer instead of string and add options for csv files ([ae9d4fe](https://github.com/OptimistikSAS/OIBus/commit/ae9d4fe09d020056ff260a62c5cc7077696dea8e))
* **translation:** improve and fix translations ([825f873](https://github.com/OptimistikSAS/OIBus/commit/825f87388892fd45f2e28fc9f95057edaf113da6))
* **vitest:** restore mocks after each test to prevent spy leaks between tests ([4dc15e9](https://github.com/OptimistikSAS/OIBus/commit/4dc15e94cad4aecd45d38a8bb0c7df246cd15a98))
* **web-client:** fix double modal on custom transformer edition ([2e193f2](https://github.com/OptimistikSAS/OIBus/commit/2e193f2ed90844da7927a7a0097d3bfb18e44dbf))
* **web-client:** fix translation of input data type ([5c6a697](https://github.com/OptimistikSAS/OIBus/commit/5c6a69795ae4933bbb9590b37a4a73f6a0d9f495))
* **web-client:** properly import array elements with erasing option ([02c6636](https://github.com/OptimistikSAS/OIBus/commit/02c6636f5c8004a4e63f07bb3a9e20a28eaaba33))
* **web-server:** log error if can not listen on port ([0a2ef79](https://github.com/OptimistikSAS/OIBus/commit/0a2ef798240a62f7ebbe476f3a06666f149e1e16))
...
* **oianalytics:** change deprecated endpoint for status test ([df9c4fa](https://github.com/OptimistikSAS/OIBus/commit/df9c4fa628e79cb81de3a5bab6ccb5ee6071ace7))
