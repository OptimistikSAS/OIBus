...
### [2.0.6](https://github.com/OptimistikSAS/OIBus/compare/v2.0.5...v2.0.6) (2022-08-09)


### Bug Fixes

* **chore:** Rename folder name for consistency with connector names ([92d53df](https://github.com/OptimistikSAS/OIBus/commit/92d53df454a302dae896dcc4777c283fc4d1d99f))
* **ci:** create prerelease ([1a32894](https://github.com/OptimistikSAS/OIBus/commit/1a3289401b894fbd080f0c8dd8a633ac484706a6))
* **deps:** adapt webpack to load monaco-editor locally instead of cdn ([7ae3bd1](https://github.com/OptimistikSAS/OIBus/commit/7ae3bd1833e9311ee1bd1f0fa110776a362392b8))
* **deps:** move client deps to dev dependencies to reduce bundle size ([de72c15](https://github.com/OptimistikSAS/OIBus/commit/de72c15bfd5bd3a7fd4f05d77ac0fa18a21c2a56))
* **deps:** replace react-json-diff by monaco editor to display config ([bfd0a41](https://github.com/OptimistikSAS/OIBus/commit/bfd0a417a92ddfa769b41bfddd45542d8b98be41))
* **deps:** update aws-sdk-js-v3 monorepo ([ff55d88](https://github.com/OptimistikSAS/OIBus/commit/ff55d8897e00daaa0c6e82ae52bd839330a1d1ab))
* **deps:** update aws-sdk-js-v3 monorepo to v3.127.0 ([9f01418](https://github.com/OptimistikSAS/OIBus/commit/9f0141884470fded9e17eb47446ff64134eec0c8))
* **deps:** update dependency @aws-sdk/client-s3 to v3.128.0 ([93553dc](https://github.com/OptimistikSAS/OIBus/commit/93553dc3a5b4709c1df5f5f5d49f3bb52d6c2288))
* **deps:** update dependency @aws-sdk/client-s3 to v3.130.0 ([f8dfddf](https://github.com/OptimistikSAS/OIBus/commit/f8dfddfd4365fbfe6a6be88a44de6835707d0a19))
* **deps:** update dependency @aws-sdk/client-s3 to v3.137.0 ([3508223](https://github.com/OptimistikSAS/OIBus/commit/3508223952beeda49fabb88d5828d89cfd420ce3))
* **deps:** update dependency @aws-sdk/client-s3 to v3.141.0 ([2d878cf](https://github.com/OptimistikSAS/OIBus/commit/2d878cf65ec5f336a3748e7b6b7a244d67deaa44))
* **deps:** update dependency @koa/router to v11 ([622223e](https://github.com/OptimistikSAS/OIBus/commit/622223e90d28a8ad266910f3a07fef07cdc154d7))
* **deps:** update dependency @koa/router to v12 ([f4af722](https://github.com/OptimistikSAS/OIBus/commit/f4af7229559c3f3798cc1927c1782203f4bb4959))
* **deps:** update dependency ads-client to v1.14.0 ([9e68157](https://github.com/OptimistikSAS/OIBus/commit/9e68157d042fbc38b839a1c733e8b14ffee3a4f5))
* **deps:** update dependency better-sqlite3 to v7.6.0 ([8600edd](https://github.com/OptimistikSAS/OIBus/commit/8600edd7caba5640077d3a4b4895969b19e40a56))
* **deps:** update dependency better-sqlite3 to v7.6.1 ([582160e](https://github.com/OptimistikSAS/OIBus/commit/582160e25369a0860b3a61f42fcbfcbde7c19518))
* **deps:** update dependency better-sqlite3 to v7.6.2 ([2491f83](https://github.com/OptimistikSAS/OIBus/commit/2491f83a61d97ff8416380b2111ccf679a6bf1cf))
* **deps:** update dependency bootstrap to v5.2.0 ([31dedf3](https://github.com/OptimistikSAS/OIBus/commit/31dedf37c54dc0b0c52542dcfe59c4942a54b12b))
* **deps:** update dependency humanize-duration to v3.27.2 ([b049623](https://github.com/OptimistikSAS/OIBus/commit/b04962357f61a27fafc70758da49a802096a84f5))
* **deps:** update dependency luxon to v3 ([2f6deae](https://github.com/OptimistikSAS/OIBus/commit/2f6deaec7a761c6c5689128b5e647bd515fe9091))
* **deps:** update dependency mongodb to v4.7.0 ([09ab74c](https://github.com/OptimistikSAS/OIBus/commit/09ab74c8f3be23c8a94733d09da60b6fc85c16f4))
* **deps:** update dependency mongodb to v4.8.0 ([14e569e](https://github.com/OptimistikSAS/OIBus/commit/14e569e59bea73a959aedda7f788f7a528f9e164))
* **deps:** update dependency mongodb to v4.8.1 ([29c0282](https://github.com/OptimistikSAS/OIBus/commit/29c0282fe248eca9f5a5d885ee3305150516f9e7))
* **deps:** update dependency mssql to v8.1.2 ([36baf24](https://github.com/OptimistikSAS/OIBus/commit/36baf24b6041637dbdb50aeb11721d25dc3de563))
* **deps:** update dependency node-opcua to v2.71.0 ([9e7e821](https://github.com/OptimistikSAS/OIBus/commit/9e7e821b6505c880b94c0561ce5595f4cd7457aa))
* **deps:** update dependency node-opcua to v2.72.0 ([3a1efda](https://github.com/OptimistikSAS/OIBus/commit/3a1efdad01bf24235994fd75ee7080902b997776))
* **deps:** update dependency node-opcua to v2.72.2 ([4669c4b](https://github.com/OptimistikSAS/OIBus/commit/4669c4b0a833a45a1d0fd914a9fcaf65bc69eced))
* **deps:** update dependency node-opcua-certificate-manager to v2.71.0 ([037b2bc](https://github.com/OptimistikSAS/OIBus/commit/037b2bc3eb1e0a4ce5e7287e177fb53c88fab691))
* **deps:** update dependency node-opcua-certificate-manager to v2.72.1 ([82cf239](https://github.com/OptimistikSAS/OIBus/commit/82cf2394c4e429e8813deb1d13bcef9040c3eb14))
* **deps:** update dependency react-flow-renderer to v10.3.8 ([1f92cf6](https://github.com/OptimistikSAS/OIBus/commit/1f92cf63bfce8565066cd4ff5b862ced3e192d4b))
* **deps:** update dependency react-icons to v4.4.0 ([0562e8b](https://github.com/OptimistikSAS/OIBus/commit/0562e8b74955e7853345c6a75d2d6432917f8068))
* **deps:** update dependency reactstrap to v9.1.1 ([f153e6b](https://github.com/OptimistikSAS/OIBus/commit/f153e6bbefc9671e8d3e024398de15a388ad61a0))
* **deps:** update dependency sqlite to v4.1.2 ([51c385f](https://github.com/OptimistikSAS/OIBus/commit/51c385f6640888da8c6bb22117c38b69b0e58898))
* **deps:** update dependency sqlite3 to v5.0.11 ([9c9f4d4](https://github.com/OptimistikSAS/OIBus/commit/9c9f4d40de804e8f740e53ccef9dc3c513c70d98))
* **deps:** update OPC client ([0321a03](https://github.com/OptimistikSAS/OIBus/commit/0321a0368b4756763cea0f3becd752e820a0018b))
* **deps:** update pino dependencies and reduce bundle size ([5cfbe66](https://github.com/OptimistikSAS/OIBus/commit/5cfbe664e78cb5e572a83be878c33995208607ca))
* **history:** change level of log when there is no history ([3c22bcf](https://github.com/OptimistikSAS/OIBus/commit/3c22bcf90da742fb9cc598b5175acf22b2f1bd71))
* **logger:** fix file log parameter update ([4f8085e](https://github.com/OptimistikSAS/OIBus/commit/4f8085e50c9fd2f1a45c14c7110d991219709733))
* **logs:** fix display of warn logs ([436f7b6](https://github.com/OptimistikSAS/OIBus/commit/436f7b66f22e5d1f095634645d44ef7671a50e37))
* **north:** fix oianalytics status data update on file sent ([4db6f64](https://github.com/OptimistikSAS/OIBus/commit/4db6f641339191f1ccc535f0257a2d72313db2d4))
* **opchda:** filter out empty points ([90e1ee3](https://github.com/OptimistikSAS/OIBus/commit/90e1ee3f44035b225d032c83c79054a2440c5053))
* **opchda:** gracefully kill the hda agent process ([5bb118a](https://github.com/OptimistikSAS/OIBus/commit/5bb118a0e89a1a798b331c09eed3bf958c8fdaaa))
* **opchda:** Send ReadIntervalDelay to HdaAgent during the initialize action ([7736946](https://github.com/OptimistikSAS/OIBus/commit/773694687bfc36189538cd50e946439b731812ea))
* **opcua-ha:** add log trace for investigation ([111a873](https://github.com/OptimistikSAS/OIBus/commit/111a8731af31c0b008bcf6d2e5aad9dcaaf6c159))
* **opcua:** add and fix logs and move some logic from Engine to ProtocolHandler ([3be1978](https://github.com/OptimistikSAS/OIBus/commit/3be1978984443636db11826fec6211ea8eb9865e))
* **SQL South:** move oracle lib load to get access to logger in case of error ([5a94b4f](https://github.com/OptimistikSAS/OIBus/commit/5a94b4f73a1031081a92835b5f0a1b592795b3ed))
* **ui:** fix init of monaco editor ([7d71638](https://github.com/OptimistikSAS/OIBus/commit/7d716386c65a2f20bfd1abf96ccb5092df33cefc))
