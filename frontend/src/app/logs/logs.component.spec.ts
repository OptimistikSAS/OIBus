...
describe('LogsComponent', () => {
  ...
  describe('Auto-reload functionality', () => {
    ...
    it('should initially have auto-reload enabled', () => {
      tester.detectChanges();
      tester.expandSearchAccordion();
    ...
    it('should display pause icon when auto-reload is active', () => {
      tester.detectChanges();
      tester.expandSearchAccordion();
    ...
    it('should display play icon when auto-reload is paused', () => {
    ...
    it('should toggle auto-reload state when button is clicked', () => {
      tester.detectChanges();
      tester.expandSearchAccordion();
    ...
    it('should not trigger immediate reload when resuming with end date', () => {
      tester.detectChanges();
      tester.expandSearchAccordion();
    ...
    it('should have both pause/resume and search buttons in the same container', () => {
      tester.detectChanges();
      tester.expandSearchAccordion();
