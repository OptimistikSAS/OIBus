...
export class ArchiveFilesComponent implements OnInit {
  ...
  changePage(pageNumber: number) {
    this.archiveFilePages = this.createPage(pageNumber);
  }

  private createPage(pageNumber: number): Page<any> {
    return createPageFromArray(this.archiveFiles, PAGE_SIZE, pageNumber);
  }
}
