...
describe('HistoryQueryListComponent', () => {
  ...
  it('should display title', () => {
    ...
    expect(tester.historyQueryList[0].elements('td')[7].elements('button').length).toBe(2);
    expect(tester.historyQueryList[0].elements('td')[7].elements('a').length).toBe(3);
    ...
    expect(tester.historyQueryList[1].elements('td')[7].elements('button').length).toBe(2);
    expect(tester.historyQueryList[1].elements('td')[7].elements('a').length).toBe(3);
  });
});
