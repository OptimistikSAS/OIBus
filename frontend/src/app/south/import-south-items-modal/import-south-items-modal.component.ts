...
export class ImportSouthItemsModalComponent {
  ...
  errorList: Array<{ item: SouthConnectorItemDTO<SouthItemSettings> | SouthConnectorItemCommandDTO<SouthItemSettings>; message: string }> =
    [];
  ...
  private createPageError(
    pageNumber: number
  ): Page<{ item: SouthConnectorItemDTO<SouthItemSettings> | SouthConnectorItemCommandDTO<SouthItemSettings>; message: string }> {
