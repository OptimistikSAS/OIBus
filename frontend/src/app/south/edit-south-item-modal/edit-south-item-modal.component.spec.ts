...
import { SouthConnectorDTO, SouthItemCommandDTO, SouthItemDTO, SouthItemManifest } from '../../../../../shared/model/south-connector.model';
...
describe('EditSouthItemModalComponent', () => {
  ...
  describe('create mode', () => {
    ...
    it('should save if valid', fakeAsync(() => {
      ...
      const expectedCommand: SouthItemCommandDTO = {
        name: 'MyName',
