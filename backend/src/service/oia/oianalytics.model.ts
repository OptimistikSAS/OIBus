 ...
 * discovered this run, exactly as retrieved — no mapping, no de-duplication, no diffing against a
 * previous run. Interpreting or correlating the records across runs is entirely OIAnalytics's own
 * concern.
 */
