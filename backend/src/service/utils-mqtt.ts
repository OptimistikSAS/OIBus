...
import {
  ...
  SouthMQTTSettingsConnectionSettings
} from '../../shared/model/south-settings.model';
import { NorthMQTTSettingsConnectionSettings } from '../../shared/model/north-settings.model';
...
export const createConnectionOptions = async (
  connectorId: string,
  connectionSettings: NorthMQTTSettingsConnectionSettings | SouthMQTTSettingsConnectionSettings,
  logger: pino.Logger
