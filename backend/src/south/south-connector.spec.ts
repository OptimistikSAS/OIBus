...
describe('SouthConnector enabled', () => {
  beforeEach(async () => {
    ...
    south = new TestSouth(configuration, [...items], addContentCallback, encryptionService, repositoryService, logger, 'baseFolder');
    await south.start();
  });
...
describe('SouthConnector disabled', () => {
  beforeEach(async () => {
    ...
    basicSouth = new SouthConnector(configuration, items, addContentCallback, encryptionService, repositoryService, logger, 'baseFolder');
