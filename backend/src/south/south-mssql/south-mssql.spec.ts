...
describe('SouthMSSQL', () => {
  beforeEach(async () => {
    ...
    (mainUtils.getMostRecentDate as jest.Mock).mockReturnValue(new Date(nowDateString));
    (mainUtils.generateReplacementParameters as jest.Mock).mockReturnValue([new Date(nowDateString), new Date(nowDateString)]);
