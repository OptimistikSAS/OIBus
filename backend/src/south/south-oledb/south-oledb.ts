...
export default class SouthOLEDB extends SouthConnector<SouthOLEDBSettings, SouthOLEDBItemSettings> implements QueriesHistory {
  ...
  async queryRemoteAgentData(item: SouthConnectorItemDTO<SouthOLEDBItemSettings>, startTime: Instant, endTime: Instant, test? : boolean): Promise<string | Record<string, any>[]> { // test is here in case we are testing items 
    let updatedStartTime = startTime;
