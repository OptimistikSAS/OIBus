    ...
    attributes: [
      {
        ...
        translationKey: 'configuration.oibus.manifest.north.opcua.shared-connection',
        validators: [],
        displayProperties: {
          row: 0,
          columns: 8,
      ...
      },
      {
        ...
        translationKey: 'configuration.oibus.manifest.north.opcua.connection-settings.title',
        displayProperties: {
          visible: true,
          wrapInBox: false
        },
