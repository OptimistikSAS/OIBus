...
import { SouthConnectorEntityLight, SouthConnectorItemEntityLight, SouthItemGroupEntityLight } from './south-connector.model';
...
export interface NorthTransformerWithOptions {
  ...
  group: SouthItemGroupEntityLight | undefined;
