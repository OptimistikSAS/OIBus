...
export default class HistoryQueryRepository {
  ...
  saveAllSouthItems<I extends SouthItemSettings>(historyQueryId: string, historyQueryItems: Array<SouthHistoryQueryItemEntity<I>>): void {
    const transaction = this.database.transaction(() => {
  ...
  saveAllNorthItems<I extends NorthItemSettings>(historyQueryId: string, historyQueryItems: Array<NorthHistoryQueryItemEntity<I>>): void {
    const transaction = this.database.transaction(() => {
      for (const item of historyQueryItems) {
