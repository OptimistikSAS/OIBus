...
describe('Repository with populated database', () => {
  ...
  describe('South Cache', () => {
    ...
    it('should delete item by groupId and itemId', () => {
      ...
      expect(repository.getItemLastValue('southId', 'item3')).not.toBeNull();
      repository.deleteItemValue('southId', 'item3');
      expect(repository.getItemLastValue('southId', 'item3')).toBeNull();
    });
    ...
    it('should delete item with null groupId using IS NULL', () => {
      ...
      expect(repository.getItemLastValue('southId', 'item4')).not.toBeNull();
      repository.deleteItemValue('southId', 'item4');
      expect(repository.getItemLastValue('southId', 'item4')).toBeNull();
    });
  });
});
