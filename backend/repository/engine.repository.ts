...
export default class EngineRepository {
  ...
  constructor(database) {
    ...
    const query = `CREATE TABLE IF NOT EXISTS ${ENGINE_TABLE} (
                   id TEXT PRIMARY KEY NOT NULL,
                   name TEXT NOT NULL,
                   log_console_level TEXT,
                   log_file_level TEXT,
                   log_file_max_file_size INTEGER,
                   log_file_number_of_files INTEGER,
                   log_database_level TEXT,
                   log_database_max_number_of_logs INTEGER,
                   log_loki_level TEXT,
                   log_loki_interval INTEGER,
                   log_loki_address TEXT,
                   log_loki_token_address TEXT,
                   log_loki_proxy_id TEXT,
                   log_loki_username TEXT,
                   log_loki_password TEXT,
                   health_signal_log_enabled INTEGER,
                   health_signal_log_interval INTEGER,
                   health_signal_http_enabled INTEGER,
                   health_signal_http_interval INTEGER,
                   health_signal_http_verbose INTEGER,
                   health_signal_http_address TEXT,
                   health_signal_http_proxy_id TEXT,
                   health_signal_http_authentication_type TEXT,
                   health_signal_http_authentication_key TEXT,
  ...
  createEngineSettings(command: EngineSettingsCommandDTO): void {
    ...
    const query =
      `INSERT INTO ${ENGINE_TABLE} SET (id, name, port, ` +
      `log_console_level, ` +
      `log_file_level, ` +
      `log_file_max_file_size, ` +
      `log_file_number_of_files, ` +
