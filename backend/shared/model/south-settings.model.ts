...
export const SOUTH_M_Q_T_T_SETTINGS_CONNECTION_SETTINGS_AUTHENTICATION_TYPES = ['none', 'basic', 'cert'] as const;
export type SouthMQTTSettingsConnectionSettingsAuthenticationType =
  (typeof SOUTH_M_Q_T_T_SETTINGS_CONNECTION_SETTINGS_AUTHENTICATION_TYPES)[number];
...
export const SOUTH_M_Q_T_T_ITEM_SETTINGS_QOSS = ['0', '1', '2'] as const;
export type SouthMQTTItemSettingsQos = (typeof SOUTH_M_Q_T_T_ITEM_SETTINGS_QOSS)[number];
...
export interface SouthMQTTSettingsConnectionSettingsAuthentication {
  type: SouthMQTTSettingsConnectionSettingsAuthenticationType;
  username?: string;
...
export interface SouthMQTTSettingsConnectionSettings {
  url: string;
  persistent: boolean;
  authentication: SouthMQTTSettingsConnectionSettingsAuthentication;
...
export interface SouthMQTTSettings {
  ...
  retryInterval: number;
  connectionSettings?: SouthMQTTSettingsConnectionSettings;
}
