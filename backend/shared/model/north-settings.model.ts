...
export const NORTH_O_P_C_U_A_SETTINGS_CONNECTION_SETTINGS_AUTHENTICATION_TYPES = ['none', 'basic', 'cert'] as const;
export type NorthOPCUASettingsConnectionSettingsAuthenticationType =
  (typeof NORTH_O_P_C_U_A_SETTINGS_CONNECTION_SETTINGS_AUTHENTICATION_TYPES)[number];

export const NORTH_O_P_C_U_A_SETTINGS_CONNECTION_SETTINGS_SECURITY_MODES = ['none', 'sign', 'sign-and-encrypt'] as const;
export type NorthOPCUASettingsConnectionSettingsSecurityMode = (typeof NORTH_O_P_C_U_A_SETTINGS_CONNECTION_SETTINGS_SECURITY_MODES)[number];

export const NORTH_O_P_C_U_A_SETTINGS_CONNECTION_SETTINGS_SECURITY_POLICYS = [
  'none',
  'basic128',
  'basic192',
  'basic192-rsa15',
...
export type NorthOPCUASettingsConnectionSettingsSecurityPolicy =
  (typeof NORTH_O_P_C_U_A_SETTINGS_CONNECTION_SETTINGS_SECURITY_POLICYS)[number];
...
export interface NorthOPCUASettingsConnectionSettingsAuthentication {
  type: NorthOPCUASettingsConnectionSettingsAuthenticationType;
  username?: string;
  password?: string | null;
  certFilePath?: string;
  keyFilePath?: string;
...
export interface NorthOPCUASettingsConnectionSettings {
  url: string;
  keepSessionAlive: boolean;
  securityMode: NorthOPCUASettingsConnectionSettingsSecurityMode;
  securityPolicy?: NorthOPCUASettingsConnectionSettingsSecurityPolicy;
  authentication: NorthOPCUASettingsConnectionSettingsAuthentication;
}
...
export interface NorthOPCUASettings {
  sharedConnection: SharedConnection | null;
  retryInterval: number;
  connectionSettings?: NorthOPCUASettingsConnectionSettings;
}
