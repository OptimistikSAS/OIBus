...
<div style={{ display: "flex", justifyContent: "space-around" }}>
  <DownloadButton link='https://github.com/OptimistikSAS/OIBus/releases/download/v2.10.0/oibus-linux.tar.gz'>
    <div>
      <div>{`OIBus v2.10`}</div>
      <div>Linux (x64)</div>
    </div>
...
```
curl -o- -L https://github.com/OptimistikSAS/OIBus/releases/download/v2.10.0/oibus-linux.tar.gz | tar -xzv
```


```
wget -c https://github.com/OptimistikSAS/OIBus/releases/download/v2.10.0/oibus-linux.tar.gz -O - | tar -xzv
```
