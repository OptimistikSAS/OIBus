...
:::tip
Authentication is checked before IP filtering restricts access. Both can be used together for defense in depth: the IP filter limits which hosts may reach the proxy, and authentication controls who may use it from those hosts.
:::
