...
## Open-source, Scalable, and Flexible {#open-source-scalable-and-flexible}
...
## A Modular, Streaming Solution {#a-modular-streaming-solution}
...
<div style={{ display: 'flex', justifyContent: 'center', marginBottom: '2rem' }}>
  <div style={{ width: '650px', height: '650px' }}>
    ...
    ![Example banner](@site/static/img/guide/oibus.svg)
...
- **Industrial Systems**: PLCs, supervisory systems, and historians using protocols like OPC UA™, OPC Classic™, TwinCAT® ADS, Siemens S7™,
  and Modbus.
- **Building Automation**: HVAC controllers, metering, and other building devices using BACnet®/IP.
- **Business Systems**: Access to databases (Oracle Database™, Microsoft SQL Server™, PostgreSQL, MySQL®, MariaDB™, SQLite™, MongoDB®) and
  file retrieval (e.g., Excel, CSV).
...
| Siemens S7™           | No                     | Yes                | Siemens PLCs                                  |
| Modbus                | No                     | Yes                | PLCs, sensors, devices                        |
| BACnet®/IP            | No                     | Yes                | Building automation, HVAC, metering           |
...
| SQL & NoSQL Databases | Yes                    | No                 | Oracle, SQL Server, PostgreSQL, MongoDB, etc. |
...
- **SaaS Applications**: OIAnalytics®, Amazon S3™, Azure Blob Storage™, Azure Data Explorer™, REST APIs, and more.
