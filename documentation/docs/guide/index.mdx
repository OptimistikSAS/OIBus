...
- **Industrial information systems**: PLCs, supervisions, historians with various protocols (OPCUA, OPC, TwinCAT® ADS, Modbus...)
- **Business information systems**: Access to business information systems by SQL queries (Oracle Database™, Microsoft SQL Server™,
...
- **SaaS Applications**: OIAnalytics®, Amazon S3™, Azure Blob Storage™, REST API...
