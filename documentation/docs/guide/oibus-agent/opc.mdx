...
### Windows settings (client) {#windows-settings-client}

#### Client machine settings {#client-machine-settings}
...
<div style={{ textAlign: 'center' }}>![Component Services](@site/static/img/guide/south/opchda/OPCHDA-component-services.png)</div>

Be sure to enable _Distributed COM_ on this computer (on the _Default Properties_ tab).

<div style={{ textAlign: 'center' }}>![Component Properties](@site/static/img/guide/south/opchda/OPCHDA-computer-properties.png)</div>

On the _COM Security_ tab, edit default _Launch and Activation Permissions_.

<div style={{ textAlign: 'center' }}>![COM Security](@site/static/img/guide/south/opchda/OPCHDA-COM-security.png)</div>
...
<div style={{ textAlign: 'center' }}>![Access Permissions](@site/static/img/guide/south/opchda/OPCHDA-access-permissions.png)</div>
...
<div style={{ textAlign: 'center' }}>![Test DCOM communication](@site/static/img/guide/south/opchda/OPCHDA-test-communication.png)</div>
...
<div style={{ textAlign: 'center' }}>![RPC Unavailable](@site/static/img/guide/south/opchda/OPCHDA-rpc-unavailable.png)</div>

##### Access denied {#access-denied}

Check user credentials and group membership if access is denied.

<div style={{ textAlign: 'center' }}>![Access denied](@site/static/img/guide/south/opchda/OPCHDA-access-denied.png)</div>
