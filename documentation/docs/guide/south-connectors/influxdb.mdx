...
[timestamp tracking](#timestamp-tracking) sets the next scan's `@StartTime` to the maximum `_time`
...
The InfluxQL (v1) and SQL (v3) examples above don't need this — they already use a strict `time >
