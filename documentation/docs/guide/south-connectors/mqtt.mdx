...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| URL                 | Address of the MQTT broker. Accepts `mqtt://`, `mqtts://`, `tcp://`, `tls://`, `ws://`, or `wss://` (use `mqtts://`/`tls://` for Certificate authentication). Default port is `1883`. | `mqtt://broker.example.com:1883` |
