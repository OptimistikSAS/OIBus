...
### Manual Configuration (when registration not used) {#manual-configuration-when-registration-not-used}
...
#### Example: querying data values {#example-querying-data-values}
...
## CSV Serialization Options {#csv-serialization-options}
