...
import WindowsInstallation from '../guide/installation/_windows.mdx';
import LinuxInstallation from '../guide/installation/_linux.mdx';
import MacOSInstallation from '../guide/installation/_macos.mdx';
