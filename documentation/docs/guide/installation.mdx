...
import WindowsInstallation from '@site/docs/guide/installation/_windows.mdx';
import LinuxInstallation from '@site/docs/guide/installation/_linux.mdx';
import MacOSInstallation from '@site/docs/guide/installation/_macos.mdx';
