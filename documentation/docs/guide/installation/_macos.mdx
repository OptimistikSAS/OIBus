...
## Allow App Execution {#allow-app-execution}
...
<div style={{ textAlign: 'center' }}>![macOS Security Settings](@site/static/img/guide/installation/macos-security.png)</div>

## Access OIBus {#access-oibus}
