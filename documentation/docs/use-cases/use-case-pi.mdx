...
![OSIsoft PI -> OIAnalytics use case](@site/static/img/use-cases/pi-oia.svg)
...
![OSIsoft PI settings](@site/static/img/use-cases/pi-settings.png)
...
![OSIsoft PI item point ID settings](@site/static/img/use-cases/pi-item-point-id.png)
...
![OSIsoft PI item query settings](@site/static/img/use-cases/pi-item-query.png)
