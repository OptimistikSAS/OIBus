...
Only the **Net ID** needs to be specified (here `127.0.0.1.1.1`).

<div style={{ textAlign: 'center' }}>

![Twincat local settings](@site/static/img/use-cases/twincat-local-settings.png)

</div>

### Remote ADS {#remote-ads}

OIBus is deployed on a separate machine and must connect to the ADS router over the network.

<div style={{ textAlign: 'center' }}>

![Twincat remote -> OIA](@site/static/img/use-cases/twincat-remote-oia.svg)

</div>

- **Router address**: `10.0.0.1`, port `48898`
...
![Twincat remote settings](@site/static/img/use-cases/twincat-remote-settings.png)
...
![ADS item settings](@site/static/img/use-cases/twincat-item.png)
