...
A best practice for sending values into OIAnalytics is to [register OIBus first](../guide/engine/oianalytics-registration.mdx).
...
For optimal functionality, it is recommended to [register OIBus](../guide/engine/oianalytics-registration.mdx) before sending
