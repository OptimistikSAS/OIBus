...
and [South OPC UA™](../guide/south-connectors/opcua.mdx) connectors pages.
...
- `name` indicates the name assigned to the OPC UA server (e.g., `OPCUA/SimulationServer`).
For instance, in this example, the OPC UA server URL is `opc.tcp://10.0.0.1:53530/OPCUA/SimulationServer`.
