...
### What release-please rewrites {#what-release-please-rewrites}
...
## 🛠 What the release workflow actually produces {#-what-the-release-workflow-actually-produces}
...
### `build` (5-platform matrix, `needs: prepare`) {#build-5-platform-matrix-needs-prepare}
...
## 🆕 Creating a pre-release {#-creating-a-pre-release}
