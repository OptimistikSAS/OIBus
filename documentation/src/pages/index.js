          ...
          <div className={clsx('col col--4')}>
            <div className="text--center">
              <Link
                ...
                to="/docs/guide/"
              >
                <Translate description="The guide button">Get familiar with OIBus</Translate>
              </Link>
            </div>
          </div>
          <div className={clsx('col col--4')}>
            <div className="text--center">
              ...
              >
                <Translate description="The install button">Install OIBus</Translate>
              </Link>
            </div>
          </div>
          <div className={clsx('col col--4')}>
            <div className="text--center">
              <Link
                ...
                to="/docs/developer/"
              >
                <Translate description="The develop button">Develop OIBus</Translate>
              </Link>
            </div>
          </div>
        </div>
