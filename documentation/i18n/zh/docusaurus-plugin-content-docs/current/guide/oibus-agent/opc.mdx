...
<div style={{ textAlign: 'center' }}>![组件服务](@site/static/img/guide/south/opchda/OPCHDA-component-services.png)</div>

请确保在该计算机上启用 *分布式 COM*（在 *默认属性* 选项卡中）。

<div style={{ textAlign: 'center' }}>![组件属性](@site/static/img/guide/south/opchda/OPCHDA-computer-properties.png)</div>

在 *COM 安全* 选项卡中，编辑默认的 *启动和激活权限*。

<div style={{ textAlign: 'center' }}>![COM 安全](@site/static/img/guide/south/opchda/OPCHDA-COM-security.png)</div>
...
<div style={{ textAlign: 'center' }}>![访问权限](@site/static/img/guide/south/opchda/OPCHDA-access-permissions.png)</div>
...
<div style={{ textAlign: 'center' }}>![测试 DCOM 通信](@site/static/img/guide/south/opchda/OPCHDA-test-communication.png)</div>
...
<div style={{ textAlign: 'center' }}>
  ![Windows 防火墙配置](@site/static/img/guide/south/opchda/OPCHDA-windows-firewall.png)
</div>

对于 Lightsail 等云主机，需配置额外的防火墙规则：

<div style={{ textAlign: 'center' }}>
  ![Lightsail 防火墙配置](@site/static/img/guide/south/opchda/OPCHDA-lightsail-firewall.png)
</div>
...
<div style={{ textAlign: 'center' }}>![RPC 不可用](@site/static/img/guide/south/opchda/OPCHDA-rpc-unavailable.png)</div>

##### 访问被拒绝 {#access-denied}

如果访问被拒绝，请检查用户凭据和组成员身份。

<div style={{ textAlign: 'center' }}>![访问被拒绝](@site/static/img/guide/south/opchda/OPCHDA-access-denied.png)</div>
...
<div style={{ textAlign: 'center' }}>
  ![服务器计算机 DCOM 配置](@site/static/img/guide/south/opchda/OPCHDA-server-DCOM-configuration.png)
</div>
