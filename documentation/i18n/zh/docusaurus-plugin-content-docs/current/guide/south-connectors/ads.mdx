...
<div style={{ textAlign: 'center' }}>![TwinCAT 静态路由工具](@site/static/img/guide/south/ads/installation-ads-distant.png)</div>

<div style={{ textAlign: 'center' }}>![添加一条 TwinCAT 静态路由](@site/static/img/guide/south/ads/routes.png)</div>
