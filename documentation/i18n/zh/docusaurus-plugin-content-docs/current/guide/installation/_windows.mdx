...
<Tabs>
  <TabItem value="windows-installer" label="Installer" default>
    ...
    <div style={{ textAlign: 'center' }}>
      ![安装程序欢迎界面](@site/static/img/guide/installation/win_installer/1.png)
    </div>
    ...
    <div style={{ textAlign: 'center' }}>
      ![安装程序接受许可协议](@site/static/img/guide/installation/win_installer/2.png)
    </div>
    ...
    **数据目录（Data Directory）**是存储其配置、缓存和日志的位置：
    <div style={{ textAlign: 'center' }}>
      ![安装程序数据文件夹路径](@site/static/img/guide/installation/win_installer/3.png)
    </div>
    ...
    <div style={{ textAlign: 'center' }}>
      ![安装程序初始变量](@site/static/img/guide/installation/win_installer/4.png)
    </div>
    ...
    未被其他实例占用即可：
    <div style={{ textAlign: 'center' }}>
      ![安装程序二进制文件路径](@site/static/img/guide/installation/win_installer/5.png)
    </div>
    ...
    检查您的设置并确认以开始安装：
    <div style={{ textAlign: 'center' }}>
      ![安装程序验证步骤](@site/static/img/guide/installation/win_installer/6.png)
    </div>
    ...
    <div style={{ textAlign: 'center' }}>
      ![安装程序完成安装](@site/static/img/guide/installation/win_installer/7.png)
    </div>

    您可以确认 OIBus 是否已作为 Windows 服务正常运行。
    <div style={{ textAlign: 'center' }}>
      ![安装程序结果服务](@site/static/img/guide/installation/win_installer/8.png)
    </div>

    二进制文件夹如下所示：
    <div style={{ textAlign: 'center' }}>
      ![安装程序结果二进制文件夹](@site/static/img/guide/installation/win_installer/9.png)
    </div>

    数据文件夹如下所示：
    <div style={{ textAlign: 'center' }}>
      ![安装程序结果数据文件夹](@site/static/img/guide/installation/win_installer/10.png)
    </div>
    ...
    <div style={{ textAlign: 'center' }}>
      ![卸载程序步骤 1](@site/static/img/guide/installation/win_uninstall/1.png)
    </div>
    3. 系统会询问是否移除该实例的所有数据（缓存、错误、归档、日志、证书以及配置/凭据数据库）。
       选择"是"以外的任何选项都会保留数据文件夹不变：
    <div style={{ textAlign: 'center' }}>
      ![卸载程序步骤 2](@site/static/img/guide/installation/win_uninstall/2.png)
    </div>
