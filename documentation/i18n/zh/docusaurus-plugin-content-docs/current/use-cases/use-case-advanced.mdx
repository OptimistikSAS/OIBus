...
### North Connectors
#### OIAnalytics
It is strongly suggested to first [register OIBus into OIAnalytics](../guide/advanced/oianalytics-registration) and to use the registration inside the North OIAnalytics
connector.
