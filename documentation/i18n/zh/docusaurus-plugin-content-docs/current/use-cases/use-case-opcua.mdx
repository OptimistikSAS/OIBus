...
## 事前
相关配置的详细信息可以在[North OIAnalytics](../guide/north-connectors/oianalytics.md)和[South OPCUA](../guide/south-connectors/opcua.mdx)连接器页面上找到。

另外，请确保所选的连接协议为OPCUA，以将其与代表完全不同技术的[OPCDA或OPC](../guide/south-connectors/opc.mdx)区分开。
