...
![MSSQL -> Azure Blob 使用案例](@site/static/img/use-cases/mssql-azure-blob.svg)
...
![MSSQL 设置](@site/static/img/use-cases/mssql-settings.png)
...
![不使用变量的 MSSQL 项目](@site/static/img/use-cases/mssql-item-1.png)
...
![MSSQL 历史记录设置](@site/static/img/use-cases/mssql-history-settings.png)
...
![使用变量的 MSSQL 项目](@site/static/img/use-cases/mssql-item-2.png)
...
![Azure Blob 设置](@site/static/img/use-cases/azure-blob-settings.png)
